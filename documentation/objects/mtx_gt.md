...
$$C_{m,n} = (A_{m,n} \stackrel{?}{\gt}^\circ B_{m,n}) \quad \equiv \quad c_{i,j} = (a_{i,j} \stackrel{?}{\gt} b_{i,j})$$

$$C_{m,n} = (A_{m,n} \stackrel{?}{\gt}^\circ b) \quad \equiv \quad c_{i,j} = (a_{i,j} \stackrel{?}{\gt} b)$$
