...
static void deleteMTXDecay (MTXDecay *mtx_decay_obj)
{
  if (mtx_decay_obj->list_out) {
    freebytes (mtx_decay_obj->list_out,
...
void mtx_decay_setup (void)
{
  ...
  class_addmethod (mtx_decay_class, (t_method) mTXDecayMatrix,
                   gensym("matrix"), A_GIMME,0);
  class_addmethod (mtx_decay_class, (t_method) mTXSetDecayParameter,
                   gensym("alpha"), A_DEFFLOAT,0);
  class_addmethod (mtx_decay_class, (t_method) mTXSetDecayMode,
                   gensym("mode"), A_DEFSYMBOL,0);
  class_addmethod (mtx_decay_class, (t_method) mTXSetDecayDirection,
