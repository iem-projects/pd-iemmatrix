...
static void mtx_isequalscalar_matrix(t_mtx_binscalar *x, t_symbol *s,
...
static void mtx_isequalscalar_list(t_mtx_binscalar *x, t_symbol *s,
                                   int argc, t_atom *argv)
{
  int n=argc;
  t_atom *ap=argv;
...
static void mtx_isequal_matrix(t_mtx_binmtx *x, t_symbol *s, int argc,
                               t_atom *argv)
{
