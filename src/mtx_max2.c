...
static void mtx_max2scalar_matrix(t_mtx_binscalar *x, t_symbol *s,
...
static void mtx_max2scalar_list(t_mtx_binscalar *x, t_symbol *s, int argc,
                                t_atom *argv)
{
  int n=argc;
  t_atom *m;
  ...
  while(n--) {
    m->a_type = A_FLOAT;
    (m++)->a_w.w_float = (atom_getfloat(argv)<offset)?offset:atom_getfloat(
                           argv);
    argv++;
  }
...
static void mtx_max2_matrix(t_mtx_binmtx *x, t_symbol *s, int argc,
                            t_atom *argv)
{
...
{
  mtx_max2_class = class_new(gensym("mtx_max2"), (t_newmethod)mtx_max2_new,
                             (t_method)mtx_binmtx_free,
                             sizeof(t_mtx_binmtx), 0, A_GIMME, 0);
  class_addmethod(mtx_max2_class, (t_method)mtx_max2_matrix,
                  gensym("matrix"), A_GIMME, 0);
  class_addmethod(mtx_max2_class, (t_method)mtx_bin_matrix2, gensym(""),
                  A_GIMME, 0);
  class_addfloat (mtx_max2_class, mtx_max2_float);
  class_addbang  (mtx_max2_class, mtx_binmtx_bang);

  mtx_max2scalar_class = class_new(gensym("mtx_max2"), 0,
                                   (t_method)mtx_binscalar_free,
                                   sizeof(t_mtx_binscalar), 0, 0);
  class_addmethod(mtx_max2scalar_class, (t_method)mtx_max2scalar_matrix,
                  gensym("matrix"), A_GIMME, 0);
